class SycCrw01CmToGrossCust < ActiveJob::Base
  ...
  def perform
        ...
        #scheduler.cron '30 12,20,06 * * *' do |x|
        scheduler.cron '10 12 * * *' do |x|
         VancustomerFromCm.delete_all
         @Vans = VanCustomer.find_by_sql("select CM00,CM01,CM02,CM03,CM04,CM05,CM06,CM07,CM08,CM09,CM10,CM11,CM12,CM13,
                  CM14,CM15,CM16,CM17,CM18,CM19,CM20,CM21,CM22,
                CM23,CM24,CM25,CM26,CM27,CM28,CM29,CM30,CM31,CM32,
            CM33,CM34,CRE_DTIME,UPD_USERID,CRE_USERID,UPD_DTIME,CM35,CM36,CM37 from cm")
            @Vans.each do |v|
